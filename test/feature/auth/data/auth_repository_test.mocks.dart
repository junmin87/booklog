...
// in book_log/test/feature/auth/data/auth_repository_test.dart.
// Do not manually edit this file.

// ignore_for_file: no_leading_underscores_for_library_prefixes
import 'dart:async' as _i4;

import 'package:book_log/core/network/api_client.dart' as _i3;
    ...
    List<int>? successCodes = const [200, 201],
      ...
      (super.noSuchMethod(
            Invocation.method(
              #post,
              [path, body],
              {#authenticated: authenticated, #successCodes: successCodes},
            ),
            returnValue: _i4.Future<Map<String, dynamic>>.value(
              <String, dynamic>{},
            ),
    ...
    List<int>? successCodes = const [200, 204],
      ...
      (super.noSuchMethod(
            Invocation.method(
              #patch,
              [path],
              {#body: body, #successCodes: successCodes},
            ),
            returnValue: _i4.Future<Map<String, dynamic>>.value(
              <String, dynamic>{},
            ),
